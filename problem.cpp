...
bool Problem::hasBoundConstraint(){ return hasBounds; }

int Problem::getProblemDimension() { return dimension; }

double Problem::getProblemOptimum() { return optimum; }

unsigned int Problem::getFunctionEvaluations(){ return evaluations; }

void Problem::setFunctionEvaluations(unsigned int evals){evaluations = evals;}

long double Problem::getBestSolutionValue(){return bestSolutionValue;}

double* Problem::getBestSoFarSolution(){ return bestSoFarSolution;}
...
void Problem::setBestSolutionValue(long double value){ bestSolutionValue = value;}
